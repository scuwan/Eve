...
public:
	...
	virtual string FindPictureEx(int x_1, int y_1, int x_2, int y_2, const char* pic_name, const char* delta_color = "000000", float sim = 0.95, int dir = 0)=0;
	...
	virtual string FindColorEx(int x_1, int y_1, int x_2, int y_2, const char* color, float sim = 0.95, int dir = 0) = 0;
	//Ω˚÷πÕ‚≤ø ‰»Î
